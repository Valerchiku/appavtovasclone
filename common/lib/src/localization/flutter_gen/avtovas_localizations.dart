...
abstract class AvtovasLocalization {
  ...
  /// No description provided for @consentProcessingData.
  ///
  /// In ru, this message translates to:
  /// **'Согласие на обработку персональных данных'**
  String get consentProcessingData;

  /// No description provided for @consentProcessingDataText.
  ///
  /// In ru, this message translates to:
  ...
  String get consentProcessingDataText;
