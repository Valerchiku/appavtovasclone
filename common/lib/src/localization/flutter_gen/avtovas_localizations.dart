...
abstract class AvtovasLocalization {
  ...
  ///
  /// In ru, this message translates to:
  /// **'Покупая билет на сервисе АвтоВАС, вы выражаете согласие с правилами сервиса и обязуетесь соблюдать текущее законодательство в сфере пассажирских перевозок'**
