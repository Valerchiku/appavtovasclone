...
abstract final class ImagesAssets {
  ...
  static const String toggleBtn = '${_assetsVector}toggle.svg';
  static const String recentIcon = '${_assetsVector}recent.svg';
  static const String datePickerIcon = '${_assetsVector}date_picker.svg';
  static const String timeIcon = '${_assetsVector}time.svg';
  static const String tripsIcon = '${_assetsVector}routes.svg';
  static const String safetyIcon = '${_assetsVector}safety.svg';
