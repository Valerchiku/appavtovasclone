...
abstract final class _Fields {
  ...
  static const String documentValidityDateRequired = 'DocumentValidityDateRequired';
  static const String documentInceptionDateRequired = 'DocumentInceptionDateRequired';
...
final class SetTicketDataTicketPersonalDataMapper implements BaseMapper<SetTicketDataTicketPersonalData> {
  @override
  ...
  SetTicketDataTicketPersonalData fromJson(Map<String, dynamic> json) {
    return SetTicketDataTicketPersonalData(
      ...
      documentInceptionDateRequired: json[_Fields.documentInceptionDateRequired],
